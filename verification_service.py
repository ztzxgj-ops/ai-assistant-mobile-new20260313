...
class AliyunEmailService:
    ...
    def send_verification_code(self, to_email, code, purpose='register'):
        ...
        try:
            ...
            if is_test_mode:
                ...
                # 调用阿里云API发送邮件
                return self._send_via_api(to_email, subject, body_html)
    ...
    def _send_via_api(self, to_email, subject, body_html):
        ...
        try:
            ...
            request.add_query_param('AddressType', '1')  # 1=使用发信地址
            request.add_query_param('ReplyToAddress', 'false')  # 不需要回复
...
class SMSService:
    ...
    def _send_via_api(self, phone, code, template_code):
        ...
        需要安装: pip3 install aliyun-python-sdk-core
