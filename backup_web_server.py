...
sys.path.insert(0, '/Users/a1-6/Documents/GJ/编程/ai助理new')
...
class BackupHandler(BaseHTTPRequestHandler):
    ...
    def serve_html(self):
        """返回HTML页面"""
        html_file = '/Users/a1-6/Documents/GJ/编程/ai助理new/backup_tool_live.html'
    ...
    def execute_backup(self):
        """执行备份"""
        script_path = '/Users/a1-6/Documents/GJ/编程/ai助理new/backup_server.sh'
        ...
        def run_backup():
            try:
                ...
                for line in process.stdout:
                    ...
                    # 从输出中提取备份目录名
                    if '本次备份目录:' in line and 'backup-' in line:
                        backup_dir = line.split('backup-')[-1].split()[0]
                        backup_dir = f"backup-{backup_dir}"
    ...
    def restore_backup(self):
        ...
        try:
            ...
            bak_path = f'/Users/a1-6/Documents/GJ/编程/ai助理new/bak/{backup_dir}'
...
BACKUP_PATH="/Users/a1-6/Documents/GJ/编程/ai助理new/bak/{backup_dir}"
