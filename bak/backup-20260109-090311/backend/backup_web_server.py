...
class BackupHandler(BaseHTTPRequestHandler):
    ...
    def execute_backup(self):
        ...
        # 根据备份类型选择脚本
        script_map = {
            'standard': '/Users/a1-6/Documents/GJ/编程/ai助理new/backup_standard.sh',  # 标准备份：所有内容但不含uploads
            'complete': '/Users/a1-6/Documents/GJ/编程/ai助理new/backup_complete_system.sh'  # 完整备份：包含uploads
        }
