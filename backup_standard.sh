...
mkdir -p "${TEMP_DIR}"/{backend,projects,dependencies,database,config,docs,server_code}
...
3. server_code_${TIMESTAMP}.tar.gz
   - 云服务器代码备份 (47.109.148.176)
   - 服务器Python代码、配置文件、脚本
   - 大小: ${SERVER_CODE_SIZE}
...
3. 恢复服务器代码：
   tar -xzf server_code_${TIMESTAMP}.tar.gz -C /var/www/ai-assistant/
